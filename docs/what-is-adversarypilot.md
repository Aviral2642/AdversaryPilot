...
![Attack surface layer analysis with Wilson confidence intervals and Z-score badges](screenshots/layer-analysis.png)
...
![Raw data JSON export for programmatic analysis](screenshots/raw-data.png)
