...
<img src="screenshots/technique-details.png" alt="Technique details showing scores, results, and execution hooks" style="max-width: 100%; width: 600px; border: 1px solid rgba(0,240,255,0.15); border-radius: 8px;">
