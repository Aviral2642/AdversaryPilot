...
![Attack surface risk heatmap showing success rates across surfaces and goals](screenshots/heatmap.png)
...
![Sensitivity analysis showing evidence depth and statistical power](screenshots/statistics.png)
...
![Bayesian belief evolution showing posterior parameter trajectories over campaign steps](screenshots/belief-evolution.png)
